...
| **Waveshare-RP2040-GEEK**  (Experimental)![screenshot](./docs/images/rp2040-geek.jpg) | RP2040-GEEK is a development board designed by Waveshare. It has USB-A, 1.14-inch LCD screen, SD card, and has external SWD, UART and I2C ports. Hold down the button when you plug it in to get the device into flashing mode. **This board does not run the ESP32 chipset. USB ethernet (NCM) mode is currently unsupported. ESP32 Maurader cannot work on this device!** On Windows you may also need to set this device to use a WinUSB driver using [Zadig](https://zadig.akeo.ie/) | <ul><li>[AliExpress](https://s.click.aliexpress.com/e/_EyliW13)</li></ul>
